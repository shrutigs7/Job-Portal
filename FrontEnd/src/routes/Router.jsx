...
import JobGrid from '../components/candidate/CandidateJobGrid';
import JobDetail from '../components/candidate/JobDetails';
...
function AppRoutes() {
    return (
        <Routes>
            ...
            <Route index element={<CandidateGrid />} />
            ...
            <Route path="/candidate" element={<CandidateDashboard />} >
                ...
                <Route path="search-jobs" element={<JobGrid />} />
            ...
            <Route path="/candidate/job/:jobId" element={<JobDetail />} />

...
function CandidateExperience() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            if (editIndex !== null) {
                ...
                await axios.put(`${API_BASE_URL}/candidate/experience/${userId}/${expId}`, formData, { headers });
                setEditIndex(null);
            } else {
    ...
    const handleDelete = async (index) => {
        ...
        try {
            ...
            await axios.delete(`${API_BASE_URL}/candidate/experience/${userId}/${expId}`, { headers });
            fetchExperiences();
        } catch (err) {
